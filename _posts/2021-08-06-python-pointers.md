...
Если вы когда-либо работали с низкоуровневыми языками как C или C++, тогда, скорее всего, слышали про указатели. Указатели позволяют достигнуть огромной эффективности в коде. Также они представляют некоторую сложность для начинающих и не только и могут привести к различным багам памяти. Есть ли они в Python и как их можно симулировать?.
...
В этой статье вы получите лучшее понимание объектной модели Python и узнаете, почему указатели в Python не существуют в реальности. Вы узнаете как имитировать поведение указателе без зубодробительного управления памятью.
